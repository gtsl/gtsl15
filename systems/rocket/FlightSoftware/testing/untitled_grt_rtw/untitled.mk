...
## Generated on : Thu Apr 02 20:14:53 2015
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Jack/Documents/Classes/ECE\ 2811\ USLI/git/gtusli15/systems/rocket/FlightSoftware/testing
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR)/untitled_grt_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include
...
DEFINES_STANDARD = -DMODEL=untitled -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/untitled_grt_rtw/rtGetInf.c $(START_DIR)/untitled_grt_rtw/rtGetNaN.c $(START_DIR)/untitled_grt_rtw/rt_nonfinite.c $(START_DIR)/untitled_grt_rtw/untitled.c $(START_DIR)/untitled_grt_rtw/untitled_data.c rt_logging.c
...
OBJS = rtGetInf.o rtGetNaN.o rt_nonfinite.o untitled.o untitled_data.o rt_logging.o
...
%.o : $(START_DIR)/untitled_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/untitled_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
